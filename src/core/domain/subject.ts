...
export const SubjectSchema = Type.Object({
  ...
  /**
   * The subject's additional resources which will be used by the user as an
   * extra study material resource (e.g: an image or audio file).
   */
  additionalStudyData: Type.Record(Type.String(), Type.Any(), {
    default: {},
  }),
  /**
...
export const UpdateSubjectSchema = Type.Partial(
  Type.Omit(CreateSubjectSchema, ['deckId']),
);
