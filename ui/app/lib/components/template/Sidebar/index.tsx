									...
									<div className="relative group">
										...
										<ul className="space-y-1 pl-6">
											{subItems.map(({ label, url }) => (
												<li key={label} className="w-full font-medium text-neutral-500 hover:text-neutral-800 rounded-sm hover:bg-neutral-100 transition-colors">
													<a href={url} className={classNames(
														useMatch(url) ? "text-neutral-900" : "",
...
const SidebarItems: SidebarItem[] = [
	{ label: "Dashboard", url: "/" },
	{ label: "Your Decks", url: "/decks" },
	{
		label: "Settings", url: "/settings", subItems: [
			{
				label: "App",
				url: "/settings/app",
			},
